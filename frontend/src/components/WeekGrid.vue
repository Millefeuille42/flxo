...
import { sortedPersons, bookings, activeOfficeId, currentWeekOffset, getWeekKey, getWeekDates, getTodayDayIndex, setSlotDesk, weekKeyDayToISO, deskCount, hoveredSlot } from '../state.js'
